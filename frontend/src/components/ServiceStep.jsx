    ...
    return (
        <div className="animate-[fadeUp_0.4s_ease_forwards]">
            ...
            <button
                onClick={next}
                disabled={!service}
                className="mt-3 w-full py-4 rounded-2xl font-bold text-sm bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white hover:from-violet-500 hover:to-fuchsia-500 shadow-xl shadow-violet-500/25 disabled:bg-white/5 disabled:text-white/20"
            >
                Continue →
            </button>
        </div>
